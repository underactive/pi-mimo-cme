...
src/
  ...
  checkpoint.ts usage thresholds, delta serialization, in-process writer via runWriter (queue depth 1), nudges; runs the validator + logs writer_metrics/checkpoint_validations
